...
/** Character-side retrieval budgets; the request runtime enforces the 372K token window. */
export const MAX_CONTEXT_LENGTH = 1200000;
export const MAX_CONTEXT_LENGTH_WITH_IMAGE = 800000;
/** Default/legacy values; runtime reads contextBudget.ts for live preferences. */
export const EFFECTIVE_CONTEXT_WINDOW_TOKENS = 372000;
export const CONTEXT_COMPACTION_RESERVE_TOKENS = 37200;
export const CONTEXT_COMPACTION_TRIGGER_TOKENS = 334800;
export const CONTEXT_HARD_TRUNCATION_KEEP_TOKENS = 20000;
/** Keep the compaction request itself comfortably below the live window. */
export const CONTEXT_COMPACTION_SUMMARY_INPUT_TOKENS = 120000;
export const FORCE_FULL_CONTEXT = true;
export const FULL_CONTEXT_CHAR_LIMIT = 1200000;
...
/** Legacy fallback only; normal requests now use a token budget. */
...
export const ACTIVE_PAPER_MULTI_CONTEXT_MAX_LENGTH = 800000;
export const SUPPLEMENTAL_PAPER_CONTEXT_MAX_CHUNKS = 40;
export const SUPPLEMENTAL_PAPER_CONTEXT_MAX_LENGTH = 160000;
export const SUPPLEMENTAL_PAPER_CONTEXT_TOTAL_MAX_LENGTH = 1000000;
/** Legacy character threshold retained for compatibility with old persisted state. */
export const CONTEXT_COMPACTION_THRESHOLD = 150000;
/** Recent turns are protected when a token-budget compaction is performed. */
export const RECENT_TURNS_PROTECTED = 5;
