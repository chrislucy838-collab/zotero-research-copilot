...
export type ConversationContextPoolEntry = {
  ...
  /** Evidence blocks corresponding to the cached base document context. */
  baseEvidenceBlocks?: EvidenceBlock[];
...
/** Per-item selected reasoning level for the active model. */
