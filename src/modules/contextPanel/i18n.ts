...
export type PanelI18n = {
  ...
  externalTranslationColdStart: string;
  externalTranslationTranslating: string;
  externalTranslationFailed: string;
  externalTranslationColdStartStatus: string;
  externalTranslationCacheReady: string;
  addToNote: string;
  addingToNote: string;
  addedToNote: string;
...
const PANEL_I18N_PLACEHOLDER_TIPS: Record<PanelLang, PanelI18nPlaceholderTips> =
  {
    "en-US": {
      placeholderGlobalTips: [
        ...
        "Paste text for Zotero Research Copilot to explain or summarize",
    ...
    "zh-CN": {
      placeholderGlobalTips: [
        "提出一个研究问题",
        "粘贴一段文字，让 Zotero Research Copilot 解释或总结",
        "比较两个方法或概念",
        "让 Zotero Research Copilot 帮你整理阅读思路",
      ],
      placeholderPaperTips: [
        "总结这篇论文的核心贡献",
        "这篇论文的方法有什么局限？",
    ...
    "zh-TW": {
      placeholderGlobalTips: [
        "提出一個研究問題",
        "貼上一段文字，讓 Zotero Research Copilot 解釋或摘要",
        "比較兩個方法或概念",
        "讓 Zotero Research Copilot 幫你整理閱讀思路",
      ],
      placeholderPaperTips: [
        "摘要這篇論文的核心貢獻",
        "這篇論文的方法有什麼侷限？",
    ...
    "ar-SA": {
      placeholderGlobalTips: [
        "اطرح سؤالًا بحثيًا",
        "الصق نصًا ليشرحه Zotero Research Copilot أو يلخصه",
...
> = {
  "zh-TW": {
    chatReadinessTitle: "Zotero Research Copilot 尚未準備好",
    chatReadinessNoModels:
      "目前沒有可用模型。請在 Zotero Research Copilot 設定中登入或重新整理模型清單。",
    chatReadinessSelectModel: "請先在 Zotero Research Copilot 設定中選擇模型，再開始對話。",
    chatReadinessCustomConfig:
      "請先在 Zotero Research Copilot 設定中補齊自訂 API Base URL 和模型，再開始對話。",
    chatReadinessOpenSettings: "開啟 Zotero Research Copilot 設定",
  },
  "ja-JP": {
    chatReadinessTitle: "Zotero Research Copilot はまだ準備できていません",
    chatReadinessNoModels:
      "利用可能なモデルがありません。Zotero Research Copilot 設定でログインするか、モデル一覧を更新してください。",
    chatReadinessSelectModel:
      "チャットを始める前に Zotero Research Copilot 設定でモデルを選択してください。",
    chatReadinessCustomConfig:
      "チャットを始める前に、Zotero Research Copilot 設定でカスタム API Base URL とモデルを入力してください。",
    chatReadinessOpenSettings: "Zotero Research Copilot 設定を開く",
  },
  "ko-KR": {
    chatReadinessTitle: "Zotero Research Copilot가 아직 준비되지 않았습니다",
    chatReadinessNoModels:
      "사용 가능한 모델이 없습니다. Zotero Research Copilot 설정에서 로그인하거나 모델 목록을 새로 고치세요.",
    chatReadinessSelectModel:
      "채팅을 시작하기 전에 Zotero Research Copilot 설정에서 모델을 선택하세요.",
    chatReadinessCustomConfig:
      "채팅을 시작하기 전에 Zotero Research Copilot 설정에서 사용자 지정 API Base URL과 모델을 입력하세요.",
    chatReadinessOpenSettings: "Zotero Research Copilot 설정 열기",
  },
  "fr-FR": {
    chatReadinessTitle: "Zotero Research Copilot n'est pas encore prêt",
    chatReadinessNoModels:
      "Aucun modèle disponible. Connectez-vous ou actualisez la liste des modèles dans les paramètres Zotero Research Copilot.",
    chatReadinessSelectModel:
      "Sélectionnez un modèle dans les paramètres Zotero Research Copilot avant de discuter.",
    chatReadinessCustomConfig:
      "Complétez l'API Base URL personnalisée et le modèle dans les paramètres Zotero Research Copilot avant de discuter.",
    chatReadinessOpenSettings: "Ouvrir les paramètres Zotero Research Copilot",
  },
  "de-DE": {
    chatReadinessTitle: "Zotero Research Copilot ist noch nicht bereit",
    chatReadinessNoModels:
      "Kein Modell verfügbar. Melden Sie sich in den Zotero Research Copilot-Einstellungen an oder aktualisieren Sie die Modellliste.",
    chatReadinessSelectModel:
      "Wählen Sie in den Zotero Research Copilot-Einstellungen ein Modell aus, bevor Sie den Chat starten.",
    chatReadinessCustomConfig:
      "Ergänzen Sie in den Zotero Research Copilot-Einstellungen die benutzerdefinierte API Base URL und das Modell, bevor Sie den Chat starten.",
    chatReadinessOpenSettings: "Zotero Research Copilot-Einstellungen öffnen",
  },
  "es-ES": {
    chatReadinessTitle: "Zotero Research Copilot aún no está listo",
    chatReadinessNoModels:
      "No hay modelos disponibles. Inicia sesión o actualiza la lista de modelos en la configuración de Zotero Research Copilot.",
    chatReadinessSelectModel:
      "Selecciona un modelo en la configuración de Zotero Research Copilot antes de iniciar el chat.",
    chatReadinessCustomConfig:
      "Completa la API Base URL personalizada y el modelo en la configuración de Zotero Research Copilot antes de iniciar el chat.",
    chatReadinessOpenSettings: "Abrir configuración de Zotero Research Copilot",
  },
  "ru-RU": {
    chatReadinessTitle: "Zotero Research Copilot ещё не готов",
    chatReadinessNoModels:
      "Нет доступных моделей. Войдите или обновите список моделей в настройках Zotero Research Copilot.",
    chatReadinessSelectModel:
      "Выберите модель в настройках Zotero Research Copilot, прежде чем начинать чат.",
    chatReadinessCustomConfig:
      "Укажите пользовательский API Base URL и модель в настройках Zotero Research Copilot, прежде чем начинать чат.",
    chatReadinessOpenSettings: "Открыть настройки Zotero Research Copilot",
  },
  "pt-BR": {
    chatReadinessTitle: "Zotero Research Copilot ainda não está pronto",
    chatReadinessNoModels:
      "Nenhum modelo disponível. Faça login ou atualize a lista de modelos nas configurações do Zotero Research Copilot.",
    chatReadinessSelectModel:
      "Selecione um modelo nas configurações do Zotero Research Copilot antes de iniciar o chat.",
    chatReadinessCustomConfig:
      "Preencha a API Base URL personalizada e o modelo nas configurações do Zotero Research Copilot antes de iniciar o chat.",
    chatReadinessOpenSettings: "Abrir configurações do Zotero Research Copilot",
  },
  "ar-SA": {
    chatReadinessTitle: "Zotero Research Copilot ليس جاهزًا بعد",
    chatReadinessNoModels:
      "لا توجد نماذج متاحة. افتح إعدادات Zotero Research Copilot لتسجيل الدخول أو تحديث قائمة النماذج.",
    chatReadinessSelectModel: "اختر نموذجًا في إعدادات Zotero Research Copilot قبل بدء المحادثة.",
    chatReadinessCustomConfig:
      "أكمل API Base URL المخصص والنموذج في إعدادات Zotero Research Copilot قبل بدء المحادثة.",
    chatReadinessOpenSettings: "فتح إعدادات Zotero Research Copilot",
  },
  "hi-IN": {
    chatReadinessTitle: "Zotero Research Copilot अभी तैयार नहीं है",
    chatReadinessNoModels:
      "कोई उपलब्ध मॉडल नहीं है। लॉग इन करने या मॉडल सूची रीफ़्रेश करने के लिए Zotero Research Copilot सेटिंग्स खोलें।",
    chatReadinessSelectModel:
      "चैट शुरू करने से पहले Zotero Research Copilot सेटिंग्स में मॉडल चुनें।",
    chatReadinessCustomConfig:
      "चैट शुरू करने से पहले Zotero Research Copilot सेटिंग्स में custom API Base URL और मॉडल पूरा करें।",
    chatReadinessOpenSettings: "Zotero Research Copilot सेटिंग्स खोलें",
  },
};
...
> = {
  "zh-TW": {
    ...
    externalTranslationColdStart: "冷啟動中...",
    externalTranslationTranslating: "翻譯中...",
    externalTranslationFailed: "翻譯失敗",
    externalTranslationColdStartStatus: "選取翻譯冷啟動中...",
    externalTranslationCacheReady: "選取翻譯快取已就緒",
    addToNote: "加入筆記",
    addingToNote: "加入中...",
    addedToNote: "已加入",
  ...
  "ja-JP": {
    ...
    externalTranslationColdStart: "コールドスタート中...",
    externalTranslationTranslating: "翻訳中...",
    externalTranslationFailed: "翻訳に失敗しました",
    externalTranslationColdStartStatus: "選択翻訳を準備中...",
    externalTranslationCacheReady: "選択翻訳のキャッシュ準備完了",
    addToNote: "ノートに追加",
    addingToNote: "追加中...",
    addedToNote: "追加済み",
  ...
  "ko-KR": {
    ...
    externalTranslationColdStart: "콜드 스타트 중...",
    externalTranslationTranslating: "번역 중...",
    externalTranslationFailed: "번역 실패",
    externalTranslationColdStartStatus: "선택 번역 준비 중...",
    externalTranslationCacheReady: "선택 번역 캐시 준비 완료",
    addToNote: "노트에 추가",
    addingToNote: "추가 중...",
    addedToNote: "추가됨",
  ...
  "fr-FR": {
    ...
    externalTranslationColdStart: "Demarrage...",
    externalTranslationTranslating: "Traduction...",
    externalTranslationFailed: "Echec de la traduction",
    externalTranslationColdStartStatus:
      "Demarrage de la traduction de selection...",
    externalTranslationCacheReady: "Cache de traduction de selection pret",
  ...
  "de-DE": {
    ...
    externalTranslationColdStart: "Start wird vorbereitet...",
    externalTranslationTranslating: "Uebersetzung...",
    externalTranslationFailed: "Uebersetzung fehlgeschlagen",
    externalTranslationColdStartStatus:
      "Auswahluebersetzung wird vorbereitet...",
    externalTranslationCacheReady: "Cache fuer Auswahluebersetzung bereit",
  ...
  "es-ES": {
    ...
    externalTranslationColdStart: "Iniciando...",
    externalTranslationTranslating: "Traduciendo...",
    externalTranslationFailed: "Error de traduccion",
    externalTranslationColdStartStatus: "Iniciando traduccion de seleccion...",
    externalTranslationCacheReady: "Cache de traduccion de seleccion listo",
  ...
  "ru-RU": {
    ...
    externalTranslationColdStart: "Запуск...",
    externalTranslationTranslating: "Перевод...",
    externalTranslationFailed: "Ошибка перевода",
    externalTranslationColdStartStatus: "Запуск перевода выделения...",
    externalTranslationCacheReady: "Кеш перевода выделения готов",
  ...
  "pt-BR": {
    ...
    externalTranslationColdStart: "Iniciando...",
    externalTranslationTranslating: "Traduzindo...",
    externalTranslationFailed: "Falha na traducao",
    externalTranslationColdStartStatus: "Iniciando traducao da selecao...",
    externalTranslationCacheReady: "Cache da traducao da selecao pronto",
  ...
  "ar-SA": {
    ...
    externalTranslationColdStart: "جار بدء التشغيل...",
    externalTranslationTranslating: "جار الترجمة...",
    externalTranslationFailed: "فشلت الترجمة",
    externalTranslationColdStartStatus: "جار تجهيز ترجمة التحديد...",
    externalTranslationCacheReady: "ذاكرة ترجمة التحديد جاهزة",
  ...
  "hi-IN": {
    ...
    externalTranslationColdStart: "शुरू हो रहा है...",
    externalTranslationTranslating: "अनुवाद हो रहा है...",
    externalTranslationFailed: "अनुवाद विफल",
    externalTranslationColdStartStatus: "चयन अनुवाद शुरू हो रहा है...",
    externalTranslationCacheReady: "चयन अनुवाद कैश तैयार है",
...
const PANEL_I18N_LOG_OVERRIDES: Record<PanelLang, PanelI18nLogKeys> = {
  "en-US": {
    ...
    trLogPdf2zhLabel: "external translation engine",
...
export function getPanelI18n(): PanelI18n {
  ...
  if (lang !== "zh-CN") {
    const base: PanelI18nBaseKeys = {
      ...
      exportChatMd: "Export Markdown file",
      ...
      chatReadinessTitle: "Zotero Research Copilot is not ready yet",
      chatReadinessNoModels:
        "No available model. Open Zotero Research Copilot Settings to log in or refresh models.",
      chatReadinessSelectModel:
        "Select a model in Zotero Research Copilot Settings before chatting.",
      chatReadinessCustomConfig:
        "Complete the custom API base URL and model in Zotero Research Copilot Settings before chatting.",
      chatReadinessOpenSettings: "Open Zotero Research Copilot Settings",
      ...
      externalTranslationColdStart: "Cold starting...",
      externalTranslationTranslating: "Translating...",
      externalTranslationFailed: "Translation failed",
      externalTranslationColdStartStatus:
        "Selection translation cold starting...",
      externalTranslationCacheReady: "Selection translation cache ready",
  ...
  return {
    ...
    modelNoModels: "暂无模型，请在设置中保存 Provider 或刷新模型列表。",
    modelClickChoose: "点击选择模型",
    modelOnlyOne: "当前仅配置了一个模型",
    chatReadinessTitle: "Zotero Research Copilot 尚未准备好",
    chatReadinessNoModels: "当前没有可用模型。请在设置中保存 Provider 或刷新模型列表。",
    chatReadinessSelectModel: "请选择一个模型后再开始对话。",
    chatReadinessCustomConfig:
      "请在设置中补全自定义 API 地址和模型后再开始对话。",
    chatReadinessOpenSettings: "打开 Zotero Research Copilot 设置",
    uploadFiles: "上传文件",
    ...
    externalTranslationColdStart: "冷启动中...",
    externalTranslationTranslating: "翻译中...",
    externalTranslationFailed: "翻译失败",
    externalTranslationColdStartStatus: "划词翻译冷启动中...",
    externalTranslationCacheReady: "划词翻译缓存已就绪",
    addToNote: "添加到笔记",
    addingToNote: "正在添加...",
    addedToNote: "已添加",
