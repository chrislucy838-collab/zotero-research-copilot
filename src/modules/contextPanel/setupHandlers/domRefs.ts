export type PanelDomRefs = {
  ...
  clearPapersBtn: HTMLButtonElement | null;
  contextUsage: HTMLDivElement | null;
  ...
  slashCollectionOption: HTMLButtonElement | null;
  ...
  exportMenuFileBtn: HTMLButtonElement | null;
  exportMenuNoteBtn: HTMLButtonElement | null;
  conversationIndex: HTMLElement | null;
  conversationIndexToggle: HTMLButtonElement | null;
  conversationIndexList: HTMLElement | null;
...
export function getPanelDomRefs(body: Element): PanelDomRefs {
  return {
    ...
    clearPapersBtn: body.querySelector(
      "#llm-clear-papers",
    ) as HTMLButtonElement | null,
    contextUsage: body.querySelector(
      "#llm-context-usage",
    ) as HTMLDivElement | null,
    contextUsageRing: body.querySelector(
      ".llm-context-usage-ring",
    ) as HTMLDivElement | null,
    ...
    slashCollectionOption: body.querySelector(
    ...
    exportMenuFileBtn: body.querySelector(
      "#llm-export-file",
    ) as HTMLButtonElement | null,
    exportMenuNoteBtn: body.querySelector(
      "#llm-export-note",
    ) as HTMLButtonElement | null,
    conversationIndex: body.querySelector(
      "#llm-conversation-index",
    ) as HTMLElement | null,
    conversationIndexToggle: body.querySelector(
      "#llm-conversation-index-toggle",
    ) as HTMLButtonElement | null,
    conversationIndexList: body.querySelector(
