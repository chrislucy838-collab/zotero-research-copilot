 ...
 * request. sourceId is derived from Zotero item IDs when absent, so the same
 * paper remains identifiable across turns, compaction, and persisted history.
 */
export type PaperContextRef = {
  ...
  availability?: PaperSourceAvailability;
};
